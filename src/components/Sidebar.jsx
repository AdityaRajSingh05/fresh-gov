...
const complianceOfficerNavItems = [
  { id: 'governance', label: 'Compliance Dashboard', icon: <FiShield size={22} />, path: '/governance' },
  { id: 'review-policy', label: 'Review Policy', icon: <FiFileText size={22} />, path: '/review-policy' },
];
